package com.ise.petsim.animal.abs;
...
import com.ise.petsim.trait.Observable;
 ...
 */
public abstract class Animal extends Observable { // observer pattern to be implemented cos I forgot what it depends on
